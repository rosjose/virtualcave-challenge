...
(brand_id, product_id, start_date, end_date, price, price_scale, currency_code)
VALUES( 1, 1, '2022-01-01', '2022-05-31', 1550, 2, 'EUR');
INSERT INTO public.t_rates
(brand_id, product_id, start_date, end_date, price, price_scale, currency_code)
VALUES( 1, 1, '2022-06-01', '2022-12-31', 1850, 2, 'USD');
INSERT INTO public.t_rates
(brand_id, product_id, start_date, end_date, price, price_scale, currency_code)
VALUES( 2, 1, '2022-01-01', '2022-05-31', 2050, 2, 'EUR');
INSERT INTO public.t_rates
(brand_id, product_id, start_date, end_date, price, price_scale, currency_code)
VALUES( 2, 1, '2022-06-01', '2022-12-31', 2250, 2, 'USD');
INSERT INTO public.t_rates
(brand_id, product_id, start_date, end_date, price, price_scale, currency_code)
VALUES( 1, 2, '2022-01-01', '2022-05-31', 2550, 2, 'EUR');
INSERT INTO public.t_rates
(brand_id, product_id, start_date, end_date, price, price_scale, currency_code)
VALUES( 1, 2, '2022-06-01', '2022-12-31', 2850, 2, 'USD');
INSERT INTO public.t_rates
(brand_id, product_id, start_date, end_date, price, price_scale, currency_code)
VALUES( 2, 2, '2022-01-01', '2022-05-31', 3050, 2, 'EUR');
INSERT INTO public.t_rates
(brand_id, product_id, start_date, end_date, price, price_scale, currency_code)
VALUES( 2, 2, '2022-06-01', '2022-12-31', 3250, 2, 'USD');
